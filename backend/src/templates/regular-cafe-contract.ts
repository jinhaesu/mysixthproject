...
<div class="contract-body" style="font-family:'Malgun Gothic','맑은 고딕',sans-serif;max-width:800px;margin:0 auto;padding:40px 32px;line-height:2.0;color:#222;font-size:14px;">
  ...
  <section class="contract-section" data-doc="labor-contract">
    ...
    <h2 style="font-size:15px;margin-top:28px;font-weight:bold;">제6조 (근로시간·근무편성)</h2>
    <p>① 소정근로시간은 월 ${a('monthly_work_hours')}을(를) 기준으로 한다. 카페 사업부의 매장 운영 특성상 고정된 시업·종업시각을 두지 아니한다.</p>
    <p>② 세부 시업·종업시각, 근무요일, 휴게시간은 매장 운영·수요 상황에 따라 회사와 근로자가 사전에 협의하여 스케줄표(근무편성표)로 정하고, 원칙적으로 근무일 1주 전에 통보한다.</p>
    <p>③ 휴게시간은 근로기준법 제54조에 따라 4시간 근로 시 30분 이상, 8시간 근로 시 1시간 이상을 근로시간 도중에 부여하며, 매장 여건에 따라 분할 부여할 수 있다.</p>
    <p>④ 스케줄이 확정된 이후 회사의 사정으로 변경이 필요한 경우 근로자에게 즉시 통보하고 동의를 구한다. 근로자의 사정으로 변경이 필요한 경우 사전에 회사에 요청하여 승인을 얻어야 한다.</p>
    <p>⑤ 근로자는 회사의 업무 특성을 고려하여 연장·야간·휴일근로를 수행할 수 있으며, 관련 수당은 근로기준법에 따라 지급하거나 별도 연봉계약서에 포괄하여 지급한다.</p>
