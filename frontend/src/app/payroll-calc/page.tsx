            ...
            <table className="w-full text-[10px]">
              ...
              <tfoot>
                <tr className="bg-indigo-50 border-t-2 border-indigo-200 font-bold text-[10px]">
                  <td className="py-2 px-2 text-indigo-900" colSpan={5}>합계 ({results.length}명)</td>
