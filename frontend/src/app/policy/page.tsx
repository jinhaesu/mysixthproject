    ...
    <div className="min-w-0 max-w-4xl">
      ...
      <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          ...
          <table className="w-full text-sm border-collapse">
            <tbody className="divide-y divide-gray-100">
              <tr><td className="py-2 pr-4 font-medium text-gray-700 w-40">출근시간 올림</td><td className="py-2 text-gray-600">30분 단위 올림 (예: 8:03 → 8:30, 8:00 → 8:00, 8:31 → 9:00)</td></tr>
              <tr><td className="py-2 pr-4 font-medium text-gray-700">퇴근시간 내림</td><td className="py-2 text-gray-600">30분 단위 내림 (예: 17:25 → 17:00, 17:30 → 17:30, 17:50 → 17:30)</td></tr>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          ...
          <table className="w-full text-sm border-collapse">
            <tbody className="divide-y divide-gray-100">
              ...
              <tr><td className="py-2 pr-4 font-medium text-gray-700">유급휴가</td><td className="py-2 text-gray-600">승인된 휴가일은 기본근무 8시간으로 인정 (무단결근 아님)</td></tr>
            </tbody>
          </table>
          ...
          <table className="w-full text-sm border-collapse">
            <tbody className="divide-y divide-gray-100">
              ...
              <tr><td className="py-2 pr-4 font-medium text-gray-700">휴일수당 (주5일 이하)</td><td className="py-2 text-gray-600 text-red-600 font-medium">공휴일만 휴일수당 적용 (주말은 미적용, 호출형 단시간 근로계약)</td></tr>
              <tr><td className="py-2 pr-4 font-medium text-gray-700">휴일수당 (주5일 초과)</td><td className="py-2 text-gray-600">주 5일 초과 근무 시 휴일(토/일/공휴일) 전체 → 휴일수당 × 1.5배</td></tr>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          ...
          <table className="w-full text-sm border-collapse">
            <tbody className="divide-y divide-gray-100">
              <tr><td className="py-2 pr-4 font-medium text-gray-700 w-40">1년 미만</td><td className="py-2 text-gray-600">1개월 완전한 달 기준 1일 발생 (최대 11일)</td></tr>
        ...
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          ...
          <table className="w-full text-sm border-collapse">
            <tbody className="divide-y divide-gray-100">
              <tr><td className="py-2 pr-4 font-medium text-gray-700 w-40">정규직 순서</td><td className="py-2 text-gray-600">웹링크 접속 → 개인정보 입력 → 관리자 확인 → 근로계약서 체결 → 출퇴근 가능</td></tr>
        ...
        {/* 7. 부서 구분 */}
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <h2 className="text-lg font-bold text-gray-900 mb-3">7. 부서 구분</h2>
          <table className="w-full text-sm border-collapse">
            <tbody className="divide-y divide-gray-100">
              <tr><td className="py-2 pr-4 font-medium text-gray-700 w-40">정규직</td><td className="py-2 text-gray-600">생산2층, 생산3층, 물류1층, 생산 야간, 물류 야간</td></tr>
              <tr><td className="py-2 pr-4 font-medium text-gray-700">파견/알바</td><td className="py-2 text-gray-600">물류, 생산2층, 생산3층</td></tr>
            </tbody>
          </table>
        </div>
        ...
        {/* 8. 시스템 기준 */}
        <div className="bg-white rounded-xl border border-gray-200 p-5">
          <h2 className="text-lg font-bold text-gray-900 mb-3">8. 시스템 기준</h2>
          <table className="w-full text-sm border-collapse">
            <tbody className="divide-y divide-gray-100">
              ...
              <tr><td className="py-2 pr-4 font-medium text-gray-700">비밀번호 보호</td><td className="py-2 text-gray-600">파견/알바 정산, 기본급 관리, 급여 계산 접근 시 + 주민번호 열람 시</td></tr>
              <tr><td className="py-2 pr-4 font-medium text-gray-700">주민번호 보호</td><td className="py-2 text-gray-600">마스킹 표시 (●●●●●●-●●●●●●●), 비밀번호 인증 후 열람 가능</td></tr>
            </tbody>
          </table>
        </div>
